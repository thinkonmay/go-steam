...
namespace GoSteamLanguageGenerator
{
    public class GoGen
    {
        ...
        public void EmitClasses(Node root, StringBuilder sb)
        {
            ...
            sb.AppendLine("    \"github.com/thinkonmay/go-steamsteamid\"");
            sb.AppendLine("    \"github.com/thinkonmay/go-steamrwu\"");
            sb.AppendLine("    \"github.com/thinkonmay/go-steamprotocol/protobuf\"");
            sb.AppendLine(")");
            sb.AppendLine();
