...
namespace GoSteamLanguageGenerator
{
    public class GoGen
    {
        ...
        public void EmitClasses(Node root, StringBuilder sb)
        {
            ...
            sb.AppendLine("    \"github.com/thinkonmay/go-steam/steamid\"");
            sb.AppendLine("    \"github.com/thinkonmay/go-steam/rwu\"");
            sb.AppendLine("    \"github.com/thinkonmay/go-steam/protocol/protobuf\"");
            sb.AppendLine(")");
            sb.AppendLine();
